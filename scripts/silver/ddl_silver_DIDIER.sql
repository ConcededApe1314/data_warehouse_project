...
-- Source: CRM
--=============================================================================
-- Check if the table 'crm_cust_info' already exists in the 'bronze' schema.
-- 'U' stands for User Table. If it exists, it will be dropped.
IF OBJECT_ID ('silver.crm_cust_info', 'U') IS NOT NULL
    DROP TABLE silver.crm_cust_info;
GO -- This command separates batches of SQL statements.

-- Create the table to hold raw customer data from the CRM.
